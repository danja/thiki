...
import it.hyperdata.thiki.sync.SyncPrefs;
import it.hyperdata.thiki.sync.SyncRunner;
	...
	public void showOrRefreshCurrentPage() {
		...
		//	public void run() {
				...
				htmlBody = htmlBody.replaceAll("thikifile\\:",
						"content://it.hyperdata.thiki.localfile/");
...
//			String page = new UrlQuerySanitizer().unescape(m.group(1));
		...
		url = url.replaceAll("content://org.hyperdata.thiki.localfile/",
	...
	private void showDropboxLoginCredentials() {
		Intent i = new Intent(this,
				it.hyperdata.thiki.sync.EditSyncPreferencesActivity.class);
